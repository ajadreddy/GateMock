    ...
    <div className="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
        ...
        <form action="">
            <div className="mt-4">
                ...
                <div className="flex">
                    <div className="w-full px-7 py-2 mt-4 text-white bg-orange-500 rounded-lg hover:bg-orange-600" style={{textAlign:"center",cursor:"pointer"}} onClick={register}>Register</div>
                    
                </div>
                <div className="mt-6 text-grey-dark">
                    Already have an account?
                    <a className="text-orange-500 hover:underline" href=" " onClick={()=>history.push('/login')}>
                        Log in
                    </a>
                </div>
            </div>
